class LeasesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to leases_path, status: :see_other, notice: "Lease was successfully destroyed." }
  ...
  private
    ...
    def lease_params
      params.expect(lease: [ :unit_id, :tenant_id, :price, :duration, :due_day, :active ])
    end
end
