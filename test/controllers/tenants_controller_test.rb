...
class TenantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tenant" do
    assert_difference("Tenant.count") do
      post tenants_url, params: { tenant: { cpf: @tenant.cpf, email: @tenant.email, name: @tenant.name, phone: @tenant.phone } }
    end
  ...
  test "should update tenant" do
    patch tenant_url(@tenant), params: { tenant: { cpf: @tenant.cpf, email: @tenant.email, name: @tenant.name, phone: @tenant.phone } }
