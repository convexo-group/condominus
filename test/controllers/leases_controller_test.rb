...
class LeasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lease" do
    assert_difference("Lease.count") do
      post leases_url, params: { lease: { active: @lease.active, due_day: @lease.due_day, duration: @lease.duration, price: @lease.price, tenant_id: @lease.tenant_id, unit_id: @lease.unit_id } }
    end
  ...
  test "should update lease" do
    patch lease_url(@lease), params: { lease: { active: @lease.active, due_day: @lease.due_day, duration: @lease.duration, price: @lease.price, tenant_id: @lease.tenant_id, unit_id: @lease.unit_id } }
